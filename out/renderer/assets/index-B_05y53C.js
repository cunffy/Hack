const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Terminal-aO9nx0o9.js","./Terminal-BXKNkDff.css"])))=>i.map(i=>d[i]);
...
const TerminalApp = reactExports.lazy(() => __vitePreload(() => import("./Terminal-aO9nx0o9.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url));
const EditorApp = reactExports.lazy(() => __vitePreload(() => import("./Editor-B8k5bF7B.js"), true ? [] : void 0, import.meta.url));
const PasswordTesterApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordTester-D_dgXp9P.js"), true ? [] : void 0, import.meta.url));
const LeakerApp = reactExports.lazy(() => __vitePreload(() => import("./LeakerApp-WVeuRoCc.js"), true ? [] : void 0, import.meta.url));
const SettingsApp = reactExports.lazy(() => __vitePreload(() => import("./SettingsApp-CAZ9sB5j.js"), true ? [] : void 0, import.meta.url));
const FilesApp = reactExports.lazy(() => __vitePreload(() => import("./FilesApp-CfawNnuL.js"), true ? [] : void 0, import.meta.url));
const LauncherApp = reactExports.lazy(() => __vitePreload(() => import("./LauncherApp-BXEW35We.js"), true ? [] : void 0, import.meta.url));
const OpticSEOApp = reactExports.lazy(() => __vitePreload(() => import("./OpticSEOApp-BWHdkwOq.js"), true ? [] : void 0, import.meta.url));
const PhoneApp = reactExports.lazy(() => __vitePreload(() => import("./PhoneApp-CkDqWPLm.js"), true ? [] : void 0, import.meta.url));
const NetworkScannerApp = reactExports.lazy(() => __vitePreload(() => import("./NetworkScannerApp-BT73mfQC.js"), true ? [] : void 0, import.meta.url));
const VPNApp = reactExports.lazy(() => __vitePreload(() => import("./VPNApp-BJ0hgp2a.js"), true ? [] : void 0, import.meta.url));
const NotesApp = reactExports.lazy(() => __vitePreload(() => import("./NotesApp-C4WVWbAK.js"), true ? [] : void 0, import.meta.url));
const MailApp = reactExports.lazy(() => __vitePreload(() => import("./MailApp-CTjlf2Mq.js"), true ? [] : void 0, import.meta.url));
const PasswordManagerApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordManagerApp-BjPHmYbi.js"), true ? [] : void 0, import.meta.url));
const SSHKeyManagerApp = reactExports.lazy(() => __vitePreload(() => import("./SSHKeyManagerApp-CXdGYzOE.js"), true ? [] : void 0, import.meta.url));
const FirewallApp = reactExports.lazy(() => __vitePreload(() => import("./FirewallApp-DTOX6l8M.js"), true ? [] : void 0, import.meta.url));
const TaskManagerApp = reactExports.lazy(() => __vitePreload(() => import("./TaskManagerApp-CdIr6eLU.js"), true ? [] : void 0, import.meta.url));
const LogViewerApp = reactExports.lazy(() => __vitePreload(() => import("./LogViewerApp-BfSFnpF1.js"), true ? [] : void 0, import.meta.url));
const NetworkMonitorApp = reactExports.lazy(() => __vitePreload(() => import("./NetworkMonitorApp-D6FCAxMK.js"), true ? [] : void 0, import.meta.url));
const ScreenshotApp = reactExports.lazy(() => __vitePreload(() => import("./ScreenshotApp-7z2QRq0X.js"), true ? [] : void 0, import.meta.url));
const CalculatorApp = reactExports.lazy(() => __vitePreload(() => import("./CalculatorApp-BtXWlRvc.js"), true ? [] : void 0, import.meta.url));
const CryptoToolsApp = reactExports.lazy(() => __vitePreload(() => import("./CryptoToolsApp-D8L8ckMK.js"), true ? [] : void 0, import.meta.url));
const APITesterApp = reactExports.lazy(() => __vitePreload(() => import("./APITesterApp-BA7eHS2A.js"), true ? [] : void 0, import.meta.url));
const CertInspectorApp = reactExports.lazy(() => __vitePreload(() => import("./CertInspectorApp-BCgM0XVX.js"), true ? [] : void 0, import.meta.url));
const DockerApp = reactExports.lazy(() => __vitePreload(() => import("./DockerApp-Db7kNJMl.js"), true ? [] : void 0, import.meta.url));
const GitApp = reactExports.lazy(() => __vitePreload(() => import("./GitApp-CQPNXEy7.js"), true ? [] : void 0, import.meta.url));
const DatabaseApp = reactExports.lazy(() => __vitePreload(() => import("./DatabaseApp-xEP6ZNHS.js"), true ? [] : void 0, import.meta.url));
const MarkdownEditorApp = reactExports.lazy(() => __vitePreload(() => import("./MarkdownEditorApp-BHENQpx5.js"), true ? [] : void 0, import.meta.url));
const TrashApp = reactExports.lazy(() => __vitePreload(() => import("./TrashApp-C7vEBl5v.js"), true ? [] : void 0, import.meta.url));
const ShodanApp = reactExports.lazy(() => __vitePreload(() => import("./ShodanApp-DtNjTa71.js"), true ? [] : void 0, import.meta.url));
const OSINTApp = reactExports.lazy(() => __vitePreload(() => import("./OSINTApp-y55KyFKH.js"), true ? [] : void 0, import.meta.url));
const CVEApp = reactExports.lazy(() => __vitePreload(() => import("./CVEApp-QE1JzEcF.js"), true ? [] : void 0, import.meta.url));
const AIAssistantApp = reactExports.lazy(() => __vitePreload(() => import("./AIAssistantApp-4d63iq_j.js"), true ? [] : void 0, import.meta.url));
const WordlistsApp = reactExports.lazy(() => __vitePreload(() => import("./WordlistsApp-B8zd1uwT.js"), true ? [] : void 0, import.meta.url));
const JSONExplorerApp = reactExports.lazy(() => __vitePreload(() => import("./JSONExplorerApp-DEyQZy6m.js"), true ? [] : void 0, import.meta.url));
const TOTPApp = reactExports.lazy(() => __vitePreload(() => import("./TOTPApp-DwZretV4.js"), true ? [] : void 0, import.meta.url));
const RegexApp = reactExports.lazy(() => __vitePreload(() => import("./RegexApp-DQz9w8wq.js"), true ? [] : void 0, import.meta.url));
const EncodingChainApp = reactExports.lazy(() => __vitePreload(() => import("./EncodingChainApp-BWy5u2U3.js"), true ? [] : void 0, import.meta.url));
const PacketSnifferApp = reactExports.lazy(() => __vitePreload(() => import("./PacketSnifferApp-BNi_1rmW.js"), true ? [] : void 0, import.meta.url));
const BackupApp = reactExports.lazy(() => __vitePreload(() => import("./BackupApp-pb9U_DDq.js"), true ? [] : void 0, import.meta.url));
const PasswordHealthApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordHealthApp-DwbAv3eN.js"), true ? [] : void 0, import.meta.url));
const PomodoroApp = reactExports.lazy(() => __vitePreload(() => import("./PomodoroApp-BbCw0S_A.js"), true ? [] : void 0, import.meta.url));
const AuditLogApp = reactExports.lazy(() => __vitePreload(() => import("./AuditLogApp-EXmyh4yB.js"), true ? [] : void 0, import.meta.url));
const CodeScannerApp = reactExports.lazy(() => __vitePreload(() => import("./CodeScannerApp-Dkf0IWom.js"), true ? [] : void 0, import.meta.url));
const WallpaperApp = reactExports.lazy(() => __vitePreload(() => import("./WallpaperApp-Wsv6g4X4.js"), true ? [] : void 0, import.meta.url));
const ClipboardHistoryApp = reactExports.lazy(() => __vitePreload(() => import("./ClipboardHistoryApp-DezFyDhQ.js"), true ? [] : void 0, import.meta.url));
const ColorPickerApp = reactExports.lazy(() => __vitePreload(() => import("./ColorPickerApp-DYu2auc5.js"), true ? [] : void 0, import.meta.url));
const UnitConverterApp = reactExports.lazy(() => __vitePreload(() => import("./UnitConverterApp-BN10ZiAS.js"), true ? [] : void 0, import.meta.url));
const WorldClockApp = reactExports.lazy(() => __vitePreload(() => import("./WorldClockApp-C2Pu504G.js"), true ? [] : void 0, import.meta.url));
const ImageViewerApp = reactExports.lazy(() => __vitePreload(() => import("./ImageViewerApp-DLAYtnWZ.js"), true ? [] : void 0, import.meta.url));
const RSSReaderApp = reactExports.lazy(() => __vitePreload(() => import("./RSSReaderApp-DYi_0qVk.js"), true ? [] : void 0, import.meta.url));
const RemoteDesktopApp = reactExports.lazy(() => __vitePreload(() => import("./RemoteDesktopApp-BFgNno3H.js"), true ? [] : void 0, import.meta.url));
const APP_COLORS$1 = {
  terminal: "#00ff88",
  editor: "#00d4ff",
