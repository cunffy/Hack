const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Terminal-BlcY4pT9.js","./Terminal-BXKNkDff.css"])))=>i.map(i=>d[i]);
...
const useWindowStore = create((set, get) => ({
  ...
  openApp(appId) {
    ...
    if (existing) {
      window.cryogram?.shell?.openAppWindow?.(appId).catch?.(() => {
      });
    ...
    window.cryogram?.shell?.openAppWindow?.(appId).then?.(() => {
      set((s) => ({
        nextZ: s.nextZ + 1,
        windows: [
  ...
  openAppNewWindow(appId) {
    ...
    set((s) => ({
      ...
      windows: [
        ...s.windows.map((w2) => ({ ...w2, focused: false })),
        { id: id2, appId, title: meta.title, x: 80 + offset, y: 80 + offset, width: meta.width, height: meta.height, minimized: false, maximized: false, focused: true, zIndex: z2 }
      ]
    }));
  },
  snapWindow(id2, side) {
    ...
    set((s) => ({
      ...
      windows: s.windows.map((w2) => {
        ...
        if (side === "max") {
          if (w2.maximized) return { ...w2, maximized: false, zIndex: z2, focused: true, ...w2.prevBounds ?? {} };
          return { ...w2, maximized: true, zIndex: z2, focused: true, prevBounds: { x: w2.x, y: w2.y, width: w2.width, height: w2.height }, x: 0, y: 0, width: W2, height: H2 };
        }
        const snapW = Math.floor(W2 / 2);
        return {
          ...w2,
          maximized: false,
          zIndex: z2,
          focused: true,
          prevBounds: w2.prevBounds ?? { x: w2.x, y: w2.y, width: w2.width, height: w2.height },
          x: side === "left" ? 0 : snapW,
          y: 0,
          width: snapW,
          height: H2
  ...
  persist(
    ...
    }),
    {
      ...
      migrate: (state, _fromVersion) => {
        const order = state?.order ?? DEFAULT_DOCK;
        return { order: order.includes("brave") ? order : ["launcher", "brave", ...order.filter((id2) => id2 !== "launcher")] };
      },
...
const APP_META = {
  ...
  brave: { label: "Brave Browser", color: "#fb923c", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BraveIcon, {}) }
};
function Dock() {
...
function BraveIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9.5 9.5l2.5 5 2.5-5", strokeWidth: "1.5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "12", y1: "14.5", x2: "12", y2: "16.5", strokeWidth: "1.5" })
  ] });
}
function Desktop() {
...
const TerminalApp = reactExports.lazy(() => __vitePreload(() => import("./Terminal-BlcY4pT9.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url));
const EditorApp = reactExports.lazy(() => __vitePreload(() => import("./Editor-D5BFYDW1.js"), true ? [] : void 0, import.meta.url));
const PasswordTesterApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordTester-BgzMsKYP.js"), true ? [] : void 0, import.meta.url));
const LeakerApp = reactExports.lazy(() => __vitePreload(() => import("./LeakerApp-B5b6es_S.js"), true ? [] : void 0, import.meta.url));
const SettingsApp = reactExports.lazy(() => __vitePreload(() => import("./SettingsApp-BCg4fy1O.js"), true ? [] : void 0, import.meta.url));
const FilesApp = reactExports.lazy(() => __vitePreload(() => import("./FilesApp-BU5Y2gyO.js"), true ? [] : void 0, import.meta.url));
const LauncherApp = reactExports.lazy(() => __vitePreload(() => import("./LauncherApp-Y_Hpwury.js"), true ? [] : void 0, import.meta.url));
const OpticSEOApp = reactExports.lazy(() => __vitePreload(() => import("./OpticSEOApp-BeqREbFE.js"), true ? [] : void 0, import.meta.url));
const PhoneApp = reactExports.lazy(() => __vitePreload(() => import("./PhoneApp-DDtB49a1.js"), true ? [] : void 0, import.meta.url));
const NetworkScannerApp = reactExports.lazy(() => __vitePreload(() => import("./NetworkScannerApp-qG6oG_eC.js"), true ? [] : void 0, import.meta.url));
const VPNApp = reactExports.lazy(() => __vitePreload(() => import("./VPNApp-CbmtRo6d.js"), true ? [] : void 0, import.meta.url));
const NotesApp = reactExports.lazy(() => __vitePreload(() => import("./NotesApp-BYFBHaCH.js"), true ? [] : void 0, import.meta.url));
const MailApp = reactExports.lazy(() => __vitePreload(() => import("./MailApp-Cj3wi4Ha.js"), true ? [] : void 0, import.meta.url));
const PasswordManagerApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordManagerApp-Dm-EEP-n.js"), true ? [] : void 0, import.meta.url));
const SSHKeyManagerApp = reactExports.lazy(() => __vitePreload(() => import("./SSHKeyManagerApp-B3h1CmZy.js"), true ? [] : void 0, import.meta.url));
const FirewallApp = reactExports.lazy(() => __vitePreload(() => import("./FirewallApp-Dbv6AfMW.js"), true ? [] : void 0, import.meta.url));
const TaskManagerApp = reactExports.lazy(() => __vitePreload(() => import("./TaskManagerApp-CEHfY87Y.js"), true ? [] : void 0, import.meta.url));
const LogViewerApp = reactExports.lazy(() => __vitePreload(() => import("./LogViewerApp-BYk8Xp8X.js"), true ? [] : void 0, import.meta.url));
const NetworkMonitorApp = reactExports.lazy(() => __vitePreload(() => import("./NetworkMonitorApp-BLXmEVai.js"), true ? [] : void 0, import.meta.url));
const ScreenshotApp = reactExports.lazy(() => __vitePreload(() => import("./ScreenshotApp-BNWf7BsY.js"), true ? [] : void 0, import.meta.url));
const CalculatorApp = reactExports.lazy(() => __vitePreload(() => import("./CalculatorApp-DeEJt1Ja.js"), true ? [] : void 0, import.meta.url));
const CryptoToolsApp = reactExports.lazy(() => __vitePreload(() => import("./CryptoToolsApp-DRV_ftg3.js"), true ? [] : void 0, import.meta.url));
const APITesterApp = reactExports.lazy(() => __vitePreload(() => import("./APITesterApp-CLpdOUcD.js"), true ? [] : void 0, import.meta.url));
const CertInspectorApp = reactExports.lazy(() => __vitePreload(() => import("./CertInspectorApp-TwooSDgA.js"), true ? [] : void 0, import.meta.url));
const DockerApp = reactExports.lazy(() => __vitePreload(() => import("./DockerApp-DqYoB4Hv.js"), true ? [] : void 0, import.meta.url));
const GitApp = reactExports.lazy(() => __vitePreload(() => import("./GitApp-DAbgDifp.js"), true ? [] : void 0, import.meta.url));
const DatabaseApp = reactExports.lazy(() => __vitePreload(() => import("./DatabaseApp-BFnHe43h.js"), true ? [] : void 0, import.meta.url));
const MarkdownEditorApp = reactExports.lazy(() => __vitePreload(() => import("./MarkdownEditorApp-Deq_sUkp.js"), true ? [] : void 0, import.meta.url));
const TrashApp = reactExports.lazy(() => __vitePreload(() => import("./TrashApp-Basn9YY5.js"), true ? [] : void 0, import.meta.url));
const ShodanApp = reactExports.lazy(() => __vitePreload(() => import("./ShodanApp-DhJO5xzY.js"), true ? [] : void 0, import.meta.url));
const OSINTApp = reactExports.lazy(() => __vitePreload(() => import("./OSINTApp-oa1PFC_5.js"), true ? [] : void 0, import.meta.url));
const CVEApp = reactExports.lazy(() => __vitePreload(() => import("./CVEApp-CQRRQshK.js"), true ? [] : void 0, import.meta.url));
const AIAssistantApp = reactExports.lazy(() => __vitePreload(() => import("./AIAssistantApp-B2BmjIsf.js"), true ? [] : void 0, import.meta.url));
const WordlistsApp = reactExports.lazy(() => __vitePreload(() => import("./WordlistsApp-CNQCPovB.js"), true ? [] : void 0, import.meta.url));
const JSONExplorerApp = reactExports.lazy(() => __vitePreload(() => import("./JSONExplorerApp-VKQhKA14.js"), true ? [] : void 0, import.meta.url));
const TOTPApp = reactExports.lazy(() => __vitePreload(() => import("./TOTPApp-Di3LIhk8.js"), true ? [] : void 0, import.meta.url));
const RegexApp = reactExports.lazy(() => __vitePreload(() => import("./RegexApp-CCRl5jqI.js"), true ? [] : void 0, import.meta.url));
const EncodingChainApp = reactExports.lazy(() => __vitePreload(() => import("./EncodingChainApp-VB070fJV.js"), true ? [] : void 0, import.meta.url));
const PacketSnifferApp = reactExports.lazy(() => __vitePreload(() => import("./PacketSnifferApp-CD8Lj2R1.js"), true ? [] : void 0, import.meta.url));
const BackupApp = reactExports.lazy(() => __vitePreload(() => import("./BackupApp-BmepyKkd.js"), true ? [] : void 0, import.meta.url));
const PasswordHealthApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordHealthApp-CPgqHkHZ.js"), true ? [] : void 0, import.meta.url));
const PomodoroApp = reactExports.lazy(() => __vitePreload(() => import("./PomodoroApp-Dx7LKlv8.js"), true ? [] : void 0, import.meta.url));
const AuditLogApp = reactExports.lazy(() => __vitePreload(() => import("./AuditLogApp-HhPmjjQo.js"), true ? [] : void 0, import.meta.url));
const CodeScannerApp = reactExports.lazy(() => __vitePreload(() => import("./CodeScannerApp-Cz5rRzWF.js"), true ? [] : void 0, import.meta.url));
const WallpaperApp = reactExports.lazy(() => __vitePreload(() => import("./WallpaperApp-BbRCQjfC.js"), true ? [] : void 0, import.meta.url));
const ClipboardHistoryApp = reactExports.lazy(() => __vitePreload(() => import("./ClipboardHistoryApp-l2uUT0K4.js"), true ? [] : void 0, import.meta.url));
const ColorPickerApp = reactExports.lazy(() => __vitePreload(() => import("./ColorPickerApp-DK9-sLpB.js"), true ? [] : void 0, import.meta.url));
const UnitConverterApp = reactExports.lazy(() => __vitePreload(() => import("./UnitConverterApp-CKlIHob0.js"), true ? [] : void 0, import.meta.url));
const WorldClockApp = reactExports.lazy(() => __vitePreload(() => import("./WorldClockApp-DxzRiIlB.js"), true ? [] : void 0, import.meta.url));
const ImageViewerApp = reactExports.lazy(() => __vitePreload(() => import("./ImageViewerApp-a43eG1qS.js"), true ? [] : void 0, import.meta.url));
const RSSReaderApp = reactExports.lazy(() => __vitePreload(() => import("./RSSReaderApp-BbKITDeA.js"), true ? [] : void 0, import.meta.url));
const RemoteDesktopApp = reactExports.lazy(() => __vitePreload(() => import("./RemoteDesktopApp-C_Uip4ky.js"), true ? [] : void 0, import.meta.url));
const APP_COLORS$1 = {
  terminal: "#00ff88",
  editor: "#00d4ff",
...
function WindowManager() {
  ...
  const cssWindows = windows.filter((w2) => !w2.native);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: cssWindows.map((win) => /* @__PURE__ */ jsxRuntimeExports.jsx(AppWindow, { window: win }, win.id)) }) });
}
...
function WorkspaceSwitcher() {
  ...
  reactExports.useEffect(() => {
    ...
    loadWindows();
    const t2 = setInterval(loadWindows, 4e3);
  ...
  reactExports.useEffect(() => {
    ...
    loadCurrent();
    const t2 = setInterval(loadCurrent, 2e3);
    return () => clearInterval(t2);
  }, [current]);
...
function PowerBtn({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { display: "flex", alignItems: "center", justifyContent: "center", color: color2, fontSize: 16, width: 18, height: 18 }, children: icon }),
...
function UserPanel({ open, onClose }) {
  ...
  const RestartIcon = /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "3 3 3 9 9 9" })
  ] });
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "6px 16px 14px" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(PowerBtn, { icon: RestartIcon, label: "Restart", color: "var(--cryo-accent)", onClick: () => setPowerConfirm("restart") }),
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            onClick: (e) => e.stopPropagation(),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 38, marginBottom: 12, lineHeight: 1, display: "flex", justifyContent: "center", alignItems: "center" }, children: powerConfirm === "sleep" ? "💤" : powerConfirm === "restart" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "38", height: "38", viewBox: "0 0 24 24", fill: "none", stroke: "var(--cryo-accent)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "3 3 3 9 9 9" })
              ] }) : "⏻" }),
...
function StatusIcons() {
  ...
  reactExports.useEffect(() => {
    ...
    load();
    const t2 = setInterval(load, 12e3);
    return () => clearInterval(t2);
  }, []);
  reactExports.useEffect(() => {
    const h = (e) => {
...
function AppSwitcherOverlay() {
  ...
  const selIdxRef = reactExports.useRef(0);
  reactExports.useEffect(() => {
  ...
  const shell = window.cryogram?.shell;
  function activateEntry(entry) {
    ...
    if (entry.type === "app" && entry.windowId) {
      ...
      shell?.sink?.();
      const id2 = entry.x11Id;
      setTimeout(() => {
        window.cryogram?.wm?.focusWindow?.(id2);
      }, 60);
    }
  }
...
function ThemeProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    ...
    r2.setProperty("--cryo-a35", hexAlpha(accent, 0.35));
    r2.setProperty("--cryo-a40", hexAlpha(accent, 0.4));
...
function UpdateScreen({ onCancel }) {
  ...
  const autoStarted = reactExports.useRef(false);
  reactExports.useEffect(() => {
    if (autoStarted.current) return;
    const api = window.cryogram?.updater;
    if (!api?.isRoot) return;
    api.isRoot().then((root) => {
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 32, width: "100%", maxWidth: 680, padding: "0 24px" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: (phase === "countdown" || phase === "restarting") && !error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, scale: 0.5 },
              animate: { opacity: 1, scale: 1 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: phase === "restarting" ? "↺" : countdown
                  },
                  countdown
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "rgba(255,255,255,0.4)", marginTop: 8 }, children: phase === "restarting" ? "Restarting now…" : `Restarting in ${countdown} second${countdown !== 1 ? "s" : ""}…` })
              ]
            }
          ) }),
...
function StepProfile({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 22, alignItems: "center" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "rgba(255,255,255,0.38)", fontFamily: "-apple-system, sans-serif" }, children: "Sets your display name across Cryogram OS" })
    ] }),
...
const APP_TITLES = {
  ...
  leaker: "Leaker — Breach Monitor",
  settings: "Settings",
  system: "Settings",
  files: "Files",
  launcher: "App Launcher",
  opticseo: "OpticSEO Pro",
  phone: "Phone",
  ...
  "cert-inspector": "Cert Inspector",
  docker: "Docker",
  git: "Git Client",
  database: "SQLite Browser",
  markdown: "Markdown Editor",
  trash: "Trash",
  shodan: "Shodan Explorer",
  osint: "OSINT Dashboard",
  cve: "CVE Database",
  "ai-assistant": "AI Assistant",
  wordlists: "Wordlist Manager",
  "json-explorer": "JSON / YAML Explorer",
  totp: "2FA / TOTP Manager",
  regex: "Regex Tester",
  "encoding-chain": "Encoding Chain",
...
function Titlebar({ appId }) {
  const ctrl = (action) => window.cryogram?.shell?.winCtrl?.(action);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/70 text-[13px] font-medium flex-1 truncate", children: APP_TITLES[appId] || appId }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
...
function StandaloneApp({ appId }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "h-screen w-screen flex flex-col overflow-hidden",
      style: { background: "var(--cryo-bg, #070b11)" },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Titlebar, { appId }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, { appId }) })
      ]
    }
  ) });
}
function App() {
  ...
  const focusedWinId = useWindowStore((s) => s.windows.find((w2) => w2.focused && !w2.minimized)?.id);
  ...
  reactExports.useEffect(() => {
    const cleanup = window.cryogram.onSnap?.((side) => {
  ...
  reactExports.useEffect(() => {
    if (!booted) return;
    let minutes = 0;
    window.cryogram.settings.get("autolock.minutes").then((v2) => {
      minutes = typeof v2 === "number" ? v2 : 0;
    }).catch(() => {
    });
    let timer;
    const reset = () => {
    ...
    const reread = async () => {
      const v2 = await window.cryogram.settings.get("autolock.minutes").catch(() => 0);
      minutes = typeof v2 === "number" ? v2 : 0;
    };
    const events = ["mousemove", "mousedown", "keydown", "touchstart"];
    events.forEach((e) => window.addEventListener(e, reset, { passive: true }));
    window.addEventListener("cryogram:autolock-changed", reread);
    reset();
    return () => {
      clearTimeout(timer);
      events.forEach((e) => window.removeEventListener(e, reset));
      window.removeEventListener("cryogram:autolock-changed", reread);
    };
  ...
  reactExports.useEffect(() => {
    const cleanup = window.cryogram.shell?.onAppWindowClosed?.((appId) => {
      const wins = useWindowStore.getState().windows;
      const w2 = wins.find((w22) => w22.appId === appId);
      if (w2) useWindowStore.getState().closeWindow(w2.id);
    });
    return cleanup ?? void 0;
  }, []);
  if (standaloneApp) return /* @__PURE__ */ jsxRuntimeExports.jsx(StandaloneApp, { appId: standaloneApp });
