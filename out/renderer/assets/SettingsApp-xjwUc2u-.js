import { r as reactExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, a as TutorialSlides, c as useThemeStore, T as THEME_PRESETS } from "./index-B5Z2VGsQ.js";
const TABS = [
...
function SecurityPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cryo-muted", children: "Configure PIN lock, auto-lock, and screen security." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-cryo-muted uppercase tracking-wider font-bold", children: "Auto-Lock" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-cryo-text", children: "Lock after inactivity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-cryo-muted", children: "Automatically locks the screen when idle" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "0", children: "Never" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "10", children: "10 minutes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "30", children: "30 minutes" })
            ]
          }
        )
      ] }),
      autoLockMinutes > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs", style: { color: "rgba(0,212,255,0.7)" }, children: [
        "Screen will lock after ",
        autoLockMinutes,
        " ",
        autoLockMinutes === 1 ? "minute" : "minutes",
        " of inactivity"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel p-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-cryo-muted uppercase tracking-wider font-bold", children: "PIN Lock" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function UpdateSection() {
  ...
  const [errorCode, setErrorCode] = reactExports.useState("");
  ...
  const startUpdate = () => {
    if (window.__cryogram_startUpdate) {
      window.__cryogram_startUpdate();
    } else {
      window.cryogram?.updater?.showUpdateScreen?.();
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel p-4 space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
      ...
      status === "error" && !isSSLError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "#f87171", maxWidth: 360, lineHeight: 1.5 }, children: errorMsg || "Could not reach update server" })
    ] }),
    status === "error" && isSSLError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "#fb923c", fontWeight: 600 }, children: "⚠ SSL certificates not installed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 11, color: "rgba(255,255,255,0.65)", lineHeight: 1.6 }, children: [
        "The update check requires SSL certificates which are missing on this system. Click ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#fb923c" }, children: "Update Now" }),
        " — the update script installs them automatically before downloading updates."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: "Update Now (auto-fixes SSL)"
        }
      )
    ] }),
