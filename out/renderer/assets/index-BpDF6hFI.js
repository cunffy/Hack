const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Terminal-CHxkNiGe.js","./Terminal-BXKNkDff.css"])))=>i.map(i=>d[i]);
...
const TerminalApp = reactExports.lazy(() => __vitePreload(() => import("./Terminal-CHxkNiGe.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url));
const EditorApp = reactExports.lazy(() => __vitePreload(() => import("./Editor-CR60gkCg.js"), true ? [] : void 0, import.meta.url));
const PasswordTesterApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordTester-DyK58iIj.js"), true ? [] : void 0, import.meta.url));
const LeakerApp = reactExports.lazy(() => __vitePreload(() => import("./LeakerApp-DhqCqTVh.js"), true ? [] : void 0, import.meta.url));
const SettingsApp = reactExports.lazy(() => __vitePreload(() => import("./SettingsApp-G4LYqBo9.js"), true ? [] : void 0, import.meta.url));
const FilesApp = reactExports.lazy(() => __vitePreload(() => import("./FilesApp-BHj7rqU1.js"), true ? [] : void 0, import.meta.url));
const LauncherApp = reactExports.lazy(() => __vitePreload(() => import("./LauncherApp-DSG8j75K.js"), true ? [] : void 0, import.meta.url));
const OpticSEOApp = reactExports.lazy(() => __vitePreload(() => import("./OpticSEOApp-ClWkLZrH.js"), true ? [] : void 0, import.meta.url));
const PhoneApp = reactExports.lazy(() => __vitePreload(() => import("./PhoneApp-u8AHETeq.js"), true ? [] : void 0, import.meta.url));
const NetworkScannerApp = reactExports.lazy(() => __vitePreload(() => import("./NetworkScannerApp-5j701rGt.js"), true ? [] : void 0, import.meta.url));
const VPNApp = reactExports.lazy(() => __vitePreload(() => import("./VPNApp-CFjO_hn4.js"), true ? [] : void 0, import.meta.url));
const NotesApp = reactExports.lazy(() => __vitePreload(() => import("./NotesApp-D9OXInXE.js"), true ? [] : void 0, import.meta.url));
const MailApp = reactExports.lazy(() => __vitePreload(() => import("./MailApp-D5xWqUle.js"), true ? [] : void 0, import.meta.url));
const PasswordManagerApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordManagerApp-DsTsCEPw.js"), true ? [] : void 0, import.meta.url));
const SSHKeyManagerApp = reactExports.lazy(() => __vitePreload(() => import("./SSHKeyManagerApp-Dd48KDkp.js"), true ? [] : void 0, import.meta.url));
const FirewallApp = reactExports.lazy(() => __vitePreload(() => import("./FirewallApp-CszDGm6u.js"), true ? [] : void 0, import.meta.url));
const TaskManagerApp = reactExports.lazy(() => __vitePreload(() => import("./TaskManagerApp-CxxTBsjS.js"), true ? [] : void 0, import.meta.url));
const LogViewerApp = reactExports.lazy(() => __vitePreload(() => import("./LogViewerApp-ChA6T0nn.js"), true ? [] : void 0, import.meta.url));
const NetworkMonitorApp = reactExports.lazy(() => __vitePreload(() => import("./NetworkMonitorApp-DBs9QkuL.js"), true ? [] : void 0, import.meta.url));
const ScreenshotApp = reactExports.lazy(() => __vitePreload(() => import("./ScreenshotApp-a8Xb3KYh.js"), true ? [] : void 0, import.meta.url));
const CalculatorApp = reactExports.lazy(() => __vitePreload(() => import("./CalculatorApp-Bacj4JqS.js"), true ? [] : void 0, import.meta.url));
const CryptoToolsApp = reactExports.lazy(() => __vitePreload(() => import("./CryptoToolsApp-CkjhjbUK.js"), true ? [] : void 0, import.meta.url));
const APITesterApp = reactExports.lazy(() => __vitePreload(() => import("./APITesterApp-BVcxJ2Z_.js"), true ? [] : void 0, import.meta.url));
const CertInspectorApp = reactExports.lazy(() => __vitePreload(() => import("./CertInspectorApp-23m_aNUm.js"), true ? [] : void 0, import.meta.url));
const DockerApp = reactExports.lazy(() => __vitePreload(() => import("./DockerApp-BTTqsFfj.js"), true ? [] : void 0, import.meta.url));
const GitApp = reactExports.lazy(() => __vitePreload(() => import("./GitApp-BVQpgL_S.js"), true ? [] : void 0, import.meta.url));
const DatabaseApp = reactExports.lazy(() => __vitePreload(() => import("./DatabaseApp-BADDzw__.js"), true ? [] : void 0, import.meta.url));
const MarkdownEditorApp = reactExports.lazy(() => __vitePreload(() => import("./MarkdownEditorApp-D6yfUkLa.js"), true ? [] : void 0, import.meta.url));
const TrashApp = reactExports.lazy(() => __vitePreload(() => import("./TrashApp-Dqfoez--.js"), true ? [] : void 0, import.meta.url));
const ShodanApp = reactExports.lazy(() => __vitePreload(() => import("./ShodanApp-1X-KtviZ.js"), true ? [] : void 0, import.meta.url));
const OSINTApp = reactExports.lazy(() => __vitePreload(() => import("./OSINTApp-Cu9SMUbg.js"), true ? [] : void 0, import.meta.url));
const CVEApp = reactExports.lazy(() => __vitePreload(() => import("./CVEApp-C9Knt9u7.js"), true ? [] : void 0, import.meta.url));
const AIAssistantApp = reactExports.lazy(() => __vitePreload(() => import("./AIAssistantApp-BmHxTBla.js"), true ? [] : void 0, import.meta.url));
const WordlistsApp = reactExports.lazy(() => __vitePreload(() => import("./WordlistsApp-lPBsmo3u.js"), true ? [] : void 0, import.meta.url));
const JSONExplorerApp = reactExports.lazy(() => __vitePreload(() => import("./JSONExplorerApp-DT0NBeQB.js"), true ? [] : void 0, import.meta.url));
const TOTPApp = reactExports.lazy(() => __vitePreload(() => import("./TOTPApp-D1V51v11.js"), true ? [] : void 0, import.meta.url));
const RegexApp = reactExports.lazy(() => __vitePreload(() => import("./RegexApp-CR2khVck.js"), true ? [] : void 0, import.meta.url));
const EncodingChainApp = reactExports.lazy(() => __vitePreload(() => import("./EncodingChainApp-zg36w6H8.js"), true ? [] : void 0, import.meta.url));
const PacketSnifferApp = reactExports.lazy(() => __vitePreload(() => import("./PacketSnifferApp-BFBuyjh2.js"), true ? [] : void 0, import.meta.url));
const BackupApp = reactExports.lazy(() => __vitePreload(() => import("./BackupApp-Bzt4_6Ok.js"), true ? [] : void 0, import.meta.url));
const PasswordHealthApp = reactExports.lazy(() => __vitePreload(() => import("./PasswordHealthApp-DdMeKg9b.js"), true ? [] : void 0, import.meta.url));
const PomodoroApp = reactExports.lazy(() => __vitePreload(() => import("./PomodoroApp-UbXd5pKA.js"), true ? [] : void 0, import.meta.url));
const AuditLogApp = reactExports.lazy(() => __vitePreload(() => import("./AuditLogApp-1z5xMWvB.js"), true ? [] : void 0, import.meta.url));
const CodeScannerApp = reactExports.lazy(() => __vitePreload(() => import("./CodeScannerApp-D7EQlJPX.js"), true ? [] : void 0, import.meta.url));
const WallpaperApp = reactExports.lazy(() => __vitePreload(() => import("./WallpaperApp-UUQDjH4s.js"), true ? [] : void 0, import.meta.url));
const ClipboardHistoryApp = reactExports.lazy(() => __vitePreload(() => import("./ClipboardHistoryApp-Cq91dvF8.js"), true ? [] : void 0, import.meta.url));
const ColorPickerApp = reactExports.lazy(() => __vitePreload(() => import("./ColorPickerApp-Cztvcry_.js"), true ? [] : void 0, import.meta.url));
const UnitConverterApp = reactExports.lazy(() => __vitePreload(() => import("./UnitConverterApp-B9V0wAtC.js"), true ? [] : void 0, import.meta.url));
const WorldClockApp = reactExports.lazy(() => __vitePreload(() => import("./WorldClockApp-CT0pm8V3.js"), true ? [] : void 0, import.meta.url));
const ImageViewerApp = reactExports.lazy(() => __vitePreload(() => import("./ImageViewerApp-CAwP7Ent.js"), true ? [] : void 0, import.meta.url));
const RSSReaderApp = reactExports.lazy(() => __vitePreload(() => import("./RSSReaderApp-CNfz5j6e.js"), true ? [] : void 0, import.meta.url));
const RemoteDesktopApp = reactExports.lazy(() => __vitePreload(() => import("./RemoteDesktopApp-BwGZWJrc.js"), true ? [] : void 0, import.meta.url));
const APP_COLORS$1 = {
  terminal: "#00ff88",
  editor: "#00d4ff",
